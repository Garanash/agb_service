...
const RegistrationPage: React.FC = () => {
  ...
  const [selectedRole, setSelectedRole] = useState<'contractor' | 'customer'>(
    'contractor',
  );
          ...
          >
            ...
            <FormControl fullWidth margin='normal' required>
              ...
              <Select
                ...
                label='Я'
                onChange={e =>
                  setSelectedRole(e.target.value as 'contractor' | 'customer')
                }
              >
            ...
            {selectedRole === 'contractor' && (
              <Box
                component='form'
                onSubmit={contractorForm.handleSubmit(onSubmitContractor)}
                noValidate
              >
                <TextField
                  margin='dense'
                  ...
                  autoFocus
                  {...contractorForm.register('username', {
                ...
                <TextField
                  ...
                  {...contractorForm.register('confirmPassword', {
                    ...
                    validate: value =>
                      value === contractorForm.watch('password') ||
                      'Пароли не совпадают',
                  })}
                  error={!!contractorForm.formState.errors.confirmPassword}
                  helperText={
                    contractorForm.formState.errors.confirmPassword?.message
                  }
                />
                ...
                <Box sx={{ display: 'flex', gap: 2, mt: 1 }}>
                  <TextField
                    fullWidth
                    label='Фамилия'
                    {...contractorForm.register('lastName', {
                      required: 'Фамилия обязательна',
                    })}
                    error={!!contractorForm.formState.errors.lastName}
                    helperText={
                      contractorForm.formState.errors.lastName?.message
                    }
                  />
                  <TextField
                    fullWidth
                    label='Имя'
                    {...contractorForm.register('firstName', {
                      required: 'Имя обязательно',
                    })}
                    error={!!contractorForm.formState.errors.firstName}
                    helperText={
                      contractorForm.formState.errors.firstName?.message
                    }
                  />
                </Box>
                ...
                <FormControl fullWidth margin='dense'>
                  ...
                  <Select
                    multiple
                    value={
                      contractorForm.watch('equipmentBrandsExperience') || []
                    }
                    onChange={e =>
                      contractorForm.setValue(
                        'equipmentBrandsExperience',
                    ...
                    {certifications.map(cert => (
                      <MenuItem key={cert} value={cert}>
                        <Checkbox
                          checked={
                            (
                              contractorForm.watch('certifications') || []
                            ).indexOf(cert) > -1
                          }
                        />
                        {cert}
                  ...
                  >
                    {workRegions.map(region => (
                      <MenuItem key={region} value={region}>
                        <Checkbox
                          checked={
                            (contractorForm.watch('workRegions') || []).indexOf(
                              region,
                            ) > -1
                          }
                        />
                ...
                <Box sx={{ display: 'flex', gap: 2, mt: 1 }}>
                  <TextField
                    ...
                    {...contractorForm.register('hourlyRate', {
                      ...
                      min: {
                        value: 0,
                        message: 'Ставка должна быть положительной',
                      },
                    })}
                    error={!!contractorForm.formState.errors.hourlyRate}
                    helperText={
                      contractorForm.formState.errors.hourlyRate?.message
                    }
                  />
                  <TextField
                    fullWidth
              ...
              >
                ...
                <TextField
                  ...
                  {...customerForm.register('confirmPassword', {
                    required: 'Подтверждение пароля обязательно',
                    validate: value =>
                      value === customerForm.watch('password') ||
                      'Пароли не совпадают',
                  })}
                ...
                <TextField
                  ...
                  helperText={
                    customerForm.formState.errors.companyName?.message
                  }
                />
                ...
                <TextField
                  ...
                  fullWidth
                  label='ИНН или ОГРН'
                  {...customerForm.register('innOrOgrn', {
                    required: 'ИНН или ОГРН обязателен',
                  })}
                    ...
                    {equipmentBrands.map(brand => (
                      <MenuItem key={brand} value={brand}>
                        <Checkbox
                          checked={
                            (
                              customerForm.watch('equipmentBrands') || []
                            ).indexOf(brand) > -1
                          }
                        />
                        {brand}
                    ...
                    {equipmentTypes.map(type => (
                      <MenuItem key={type} value={type}>
                        <Checkbox
                          checked={
                            (
                              customerForm.watch('equipmentTypes') || []
                            ).indexOf(type) > -1
                          }
                        />
                        {type}
                    ...
                    {miningOperations.map(operation => (
                      <MenuItem key={operation} value={operation}>
                        <Checkbox
                          checked={
                            (
                              customerForm.watch('miningOperations') || []
                            ).indexOf(operation) > -1
                          }
                        />
                        {operation}
      ...
      >
        ...
        <DialogContent sx={{ textAlign: 'center', pt: 1 }}>
          ...
          <DialogContentText sx={{ mb: 2 }}>
            Мы отправили вам на почту <strong>{registeredEmail}</strong> код
            подтверждения. Пожалуйста, проверьте вашу почту и перейдите по
