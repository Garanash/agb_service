...
class SimpleEmailService:
    def __init__(self):
        """Инициализация простого сервиса отправки почты через SMTP"""
    ...
    def send_email_via_smtp(self, to_email: str, subject: str, html_content: str, plain_text: str = None) -> bool:
        ...
        try:
            ...
            msg["To"] = to_email
            msg["Subject"] = subject
            msg.set_content(plain_text or html_content, subtype='html')
...
© 2025 Neurofork. Все права защищены.
            ...
            return self.send_email_via_smtp(user_email, "Подтверждение email адреса", html_content, plain_text)
